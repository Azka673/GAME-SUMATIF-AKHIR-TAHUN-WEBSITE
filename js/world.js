...
export const ROOMS = [
  // Lantai 1
  { id: 'lobby', floor: 0, x: 720, y: 620, w: 560, h: 260, name: 'Lobby & Pintu Masuk', type: 'hall', color: '#a8c8e8', accent: '#88aaff' },
  { id: 'kantin', floor: 0, x: 40, y: 80, w: 520, h: 380, name: 'Kantin', type: 'cafeteria', color: '#dcc9a8', accent: '#ffaa66' },
  { id: 'kelas_1a', floor: 0, x: 40, y: 500, w: 300, h: 280, name: 'Kelas 1-A', type: 'classroom', color: '#c8dff8', accent: '#66ccff' },
  { id: 'kelas_1b', floor: 0, x: 360, y: 500, w: 300, h: 280, name: 'Kelas 1-B', type: 'classroom', color: '#c8dff8', accent: '#66ccff' },
  { id: 'perpus_bawah', floor: 0, x: 1240, y: 80, w: 380, h: 320, name: 'Perpustakaan', type: 'library', color: '#dcc9a8', accent: '#ccaa66' },
  { id: 'uks', floor: 0, x: 1240, y: 430, w: 280, h: 200, name: 'UKS', type: 'medical', color: '#b8e8d0', accent: '#66ffaa' },
  { id: 'kantor_guru_1', floor: 0, x: 1540, y: 80, w: 420, h: 220, name: 'Kantor Guru', type: 'office', color: '#d8c8e8', accent: '#cc88ff' },
  { id: 'gym', floor: 0, x: 1540, y: 330, w: 420, h: 450, name: 'Gor Olahraga', type: 'gym', color: '#b8e8d8', accent: '#44ff88' },
  { id: 'toilet_1', floor: 0, x: 700, y: 80, w: 160, h: 140, name: 'Toilet Lantai 1', type: 'toilet', color: '#d4d4d4', accent: '#aaa' },
  // Lantai 2
  { id: 'koridor_2', floor: 1, x: 680, y: 80, w: 640, h: 120, name: 'Koridor Utama Lantai 2', type: 'hall', color: '#a8c8e8', accent: '#88aaff' },
  { id: 'kelas_2a', floor: 1, x: 40, y: 220, w: 300, h: 280, name: 'Kelas 2-A', type: 'classroom', color: '#c8dff8', accent: '#66ccff' },
  { id: 'kelas_2b', floor: 1, x: 360, y: 220, w: 300, h: 280, name: 'Kelas 2-B', type: 'classroom', color: '#c8dff8', accent: '#66ccff' },
  { id: 'kelas_2c', floor: 1, x: 40, y: 540, w: 300, h: 280, name: 'Kelas 2-C', type: 'classroom', color: '#c8dff8', accent: '#66ccff' },
  { id: 'lab_ipa', floor: 1, x: 1240, y: 220, w: 360, h: 300, name: 'Lab IPA', type: 'lab', color: '#b8e8d8', accent: '#44ffcc' },
  { id: 'lab_komputer', floor: 1, x: 1240, y: 540, w: 360, h: 280, name: 'Lab Komputer', type: 'lab', color: '#c8d8f8', accent: '#00f5ff' },
  { id: 'lab_bahasa', floor: 1, x: 1620, y: 220, w: 340, h: 280, name: 'Lab Bahasa', type: 'lab', color: '#e8c8e8', accent: '#ff88cc' },
  { id: 'ruang_guru_2', floor: 1, x: 1620, y: 540, w: 340, h: 280, name: 'Ruang Guru', type: 'office', color: '#d8c8e8', accent: '#cc88ff' },
  { id: 'osis', floor: 1, x: 360, y: 540, w: 280, h: 280, name: 'Ruang OSIS', type: 'office', color: '#e8dcc0', accent: '#ffcc44' },
  { id: 'toilet_2', floor: 1, x: 700, y: 540, w: 160, h: 140, name: 'Toilet Lantai 2', type: 'toilet', color: '#d4d4d4', accent: '#aaa' },
  // Lantai 3
  { id: 'koridor_3', floor: 2, x: 680, y: 80, w: 640, h: 120, name: 'Koridor Utama Lantai 3', type: 'hall', color: '#a8c8e8', accent: '#88aaff' },
  { id: 'kelas_3a', floor: 2, x: 40, y: 220, w: 300, h: 280, name: 'Kelas 3-A', type: 'classroom', color: '#c8dff8', accent: '#66ccff' },
  { id: 'kelas_3b', floor: 2, x: 360, y: 220, w: 300, h: 280, name: 'Kelas 3-B', type: 'classroom', color: '#c8dff8', accent: '#66ccff' },
  { id: 'seni', floor: 2, x: 40, y: 540, w: 300, h: 280, name: 'Ruang Seni', type: 'art', color: '#e8c8d8', accent: '#ff66aa' },
  { id: 'musik', floor: 2, x: 360, y: 540, w: 300, h: 280, name: 'Ruang Musik', type: 'music', color: '#d8c8e8', accent: '#aa66ff' },
  { id: 'perpus_atas', floor: 2, x: 1240, y: 220, w: 380, h: 300, name: 'Perpustakaan Atas', type: 'library', color: '#dcc9a8', accent: '#ccaa66' },
  { id: 'kepsek', floor: 2, x: 1240, y: 540, w: 360, h: 280, name: 'Ruang Kepala Sekolah', type: 'office', color: '#e8dcc0', accent: '#ffd700' },
  { id: 'rooftop', floor: 2, x: 1620, y: 220, w: 340, h: 600, name: 'Akses Rooftop', type: 'outdoor', color: '#c8dff8', accent: '#88ddff' },
  { id: 'toilet_3', floor: 2, x: 700, y: 540, w: 160, h: 140, name: 'Toilet Lantai 3', type: 'toilet', color: '#d4d4d4', accent: '#aaa' },
];
  ...
  _buildDecorations() {
    ...
    ROOMS.forEach(room => {
      ...
      if (room.type === 'classroom') {
        ...
        dec.push({ floor: room.floor, x: room.x + room.w - 120, y: room.y + oy + room.h - 50, type: 'teacher_desk', color: '#8866ff' });
        dec.push({ floor: room.floor, x: room.x + 30, y: room.y + oy + room.h - 40, type: 'trash_bin', color: '#666666' });
        dec.push({ floor: room.floor, x: room.x + room.w - 50, y: room.y + oy + room.h - 80, type: 'bookshelf', color: '#8B4513' });
      }
      if (room.type === 'cafeteria') {
        for (let i = 0; i < 8; i++) {
          dec.push({ floor: room.floor, x: room.x + 60 + (i % 4) * 110, y: room.y + oy + 80 + Math.floor(i / 4) * 120, type: 'table' });
        }
        dec.push({ floor: room.floor, x: room.x + room.w - 100, y: room.y + oy + 80, type: 'counter', color: '#cc6644' });
        dec.push({ floor: room.floor, x: room.x + room.w - 80, y: room.y + oy + 120, type: 'cooler', color: '#aaddff' });
        dec.push({ floor: room.floor, x: room.x + 50, y: room.y + oy + 50, type: 'plant', color: '#44ff88' });
      }
      if (room.type === 'lab') {
        for (let i = 0; i < 4; i++) {
        ...
        dec.push({ floor: room.floor, x: room.x + 60, y: room.y + oy + 60, type: 'equipment', color: '#ffaa44' });
        dec.push({ floor: room.floor, x: room.x + room.w - 120, y: room.y + oy + room.h - 60, type: 'sink', color: '#cccccc' });
      }
      if (room.type === 'library') {
        ...
        dec.push({ floor: room.floor, x: room.x + room.w - 60, y: room.y + oy + room.h / 2, type: 'reading_chair', color: '#8B6914' });
      }
      if (room.type === 'gym') {
        dec.push({ floor: room.floor, x: cx - 60, y: cy, type: 'hoop' });
        dec.push({ floor: room.floor, x: room.x + 80, y: room.y + oy + 100, type: 'bench_gym' });
        dec.push({ floor: room.floor, x: room.x + room.w - 100, y: room.y + oy + 120, type: 'weight_rack', color: '#777777' });
        dec.push({ floor: room.floor, x: room.x + 60, y: room.y + oy + room.h - 50, type: 'mat', color: '#ff6644' });
      }
      if (room.type === 'hall' || room.id.startsWith('koridor')) {
        for (let i = 0; i < 5; i++) {
          dec.push({ floor: room.floor, x: 700 + i * 120, y: room.y + oy + (room.h || 80) / 2, type: 'locker' });
        }
        dec.push({ floor: room.floor, x: room.x + room.w / 2 - 40, y: room.y + oy + 30, type: 'bulletin_board', color: '#cc8844' });
      }
      if (room.type === 'medical') {
        dec.push({ floor: room.floor, x: room.x + room.w / 2 - 30, y: room.y + oy + 80, type: 'bed', color: '#ffffff' });
        dec.push({ floor: room.floor, x: room.x + 50, y: room.y + oy + 60, type: 'cabinet', color: '#aaaaaa' });
      }
      if (room.type === 'office') {
        dec.push({ floor: room.floor, x: room.x + room.w / 2 - 40, y: room.y + oy + 80, type: 'desk', color: '#8B4513' });
        dec.push({ floor: room.floor, x: room.x + 80, y: room.y + oy + 100, type: 'bookshelf', color: '#8B4513' });
        dec.push({ floor: room.floor, x: room.x + 40, y: room.y + oy + 50, type: 'plant', color: '#44ff88' });
      }
      if (room.type === 'art' || room.type === 'music') {
        dec.push({ floor: room.floor, x: room.x + 60, y: room.y + oy + 80, type: 'instruments', color: '#ffaa44' });
        dec.push({ floor: room.floor, x: room.x + room.w - 80, y: room.y + oy + 100, type: 'art_display', color: '#ff88cc' });
      }
    });
    return dec;
  }
